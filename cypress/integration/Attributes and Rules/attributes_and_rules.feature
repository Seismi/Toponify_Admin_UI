...
Feature: Attributes and Rules CRUD
  ...
  Background:
    ...
    And the user selects Attributes and Rules menu item
  ...
  Scenario: Create attribute and cancel
    ...
    And the 'attribute' called 'Automated Regression Test Attribute' should not exist in the attributes and rules table immediately

  @attributes_and_rules
  Scenario: Create attribute and confrim
    ...
    And the 'attribute' called 'Automated Regression Test Attribute' should exist in the attributes and rules table immediately
