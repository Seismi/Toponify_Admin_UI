...
Feature: Basic create, read, update and delete for RADIOs in the /radio screen
  ...
  Background:
    ...
    And the radio 'Automatic Regression Test Assumption 2' does not exist
  ...
  Scenario: Start creating radio then cancel
    When the user creates a radio with title 'Created Automatic Regression Test Risk 1', category 'risk', status 'new', description 'Automatic Regression Test Risk 1 Description' which is assigned to 'Automated Test' and should be actioned by '' and mitigation resolution '' and have severity 1 and probability 2
  ...
  Scenario: Create simple radio
    And the user creates a radio with title 'Created Automatic Regression Test Risk 1', category 'risk', status 'new', description 'Automatic Regression Test Risk 1 Description' which is assigned to 'Automated Test' and should be actioned by '' and mitigation resolution '' and have severity 1 and probability 2
  ...
  Scenario: Create a complete radio
  	And the user creates a radio with title 'Automatic Regression Test Assumption 2', category 'assumption', status 'open', description 'Automatic Regresssion Test Assumption 2 with full details' which is assigned to 'Automated Test' and should be actioned by 'Wed Dec 30 2020' and mitigation resolution 'Automatic Regression Test Assumption 2 Mitigation' and have severity 1 and probability 2
  	And confirms the creation of the radio
  	Then the radio with title 'Automatic Regression Test Assumption 2' should be immediately visible in the radio table
  	And the radio with the title 'Automatic Regression Test Assumption 2' should have the category 'assumption', status 'open', description 'Automatic Regresssion Test Assumption 2 with full details', assigned to 'Automated Test', be actioned by 'Wed Dec 30 2020', with mitigation resolution 'Automatic Regression Test Assumption 2 Mitigation' and have severity 1 and probability 2

  @radio
  Scenario: Start updating radio then cancel
    Given the user creates a radio with title 'Created Automatic Regression Test Risk 1', category 'risk', status 'new', description 'Automatic Regression Test Risk 1 Description' which is assigned to 'Automated Test' and should be actioned by '' and mitigation resolution '' and have severity 1 and probability 2
    And confirms the creation of the radio
  ...
  Scenario: Start updating RADIO then cancel on reply
    ...
    Then the radio with title 'Created Automatic Regression Test Risk 1' should be immediately visible in the radio table
    And the radio with the title 'Created Automatic Regression Test Risk 1' should have the category 'risk', status 'new', description 'Automatic Regression Test Risk 1 Description', assigned to 'Automated Test', be actioned by '', with mitigation resolution '' and have severity 1 and probability 2
  ...
  Scenario: Update RADIO
    ...
    Then the radio with title 'Created Automatic Regression Test Risk 1' should be immediately visible in the radio table
    And the radio with the title 'Created Automatic Regression Test Risk 1' should have the category 'risk', status 'new', description 'Automatic regression test description change', assigned to 'Automated Test', be actioned by '', with mitigation resolution '' and have severity 1 and probability 2
  ...
  Scenario: Cancel Closing RADIO
    Given the user creates a radio with title 'Created Automatic Regression Test Risk 1', category 'risk', status 'new', description 'Automatic regression test description change' which is assigned to 'Automated Test' and should be actioned by '' and mitigation resolution '' and have severity 1 and probability 2
    And confirms the creation of the radio
	  And the radio 'Created Automatic Regression Test Risk 1' exists with title 'Created Automatic Regression Test Risk 1', category 'risk', status 'new', description 'Automatic regression test description change' which is assigned to 'Automated Test' and should be actioned by '' and mitigation resolution '' and have severity 1 and probability 2
  ...
  Scenario: Closing RADIO
    ...
    Then the radio with title 'Created Automatic Regression Test Risk 1' should be immediately visible in the radio table
    And the radio with the title 'Created Automatic Regression Test Risk 1' should have the category 'risk', status 'closed', description 'Automatic regression test description change', assigned to 'Automated Test', be actioned by '', with mitigation resolution '' and have severity 1 and probability 2
  ...
  Scenario: Cancel Delete RADIO
    Given the user creates a radio with title 'Created Automatic Regression Test Risk 1', category 'risk', status 'closed', description 'Automatic regression test description change' which is assigned to 'Automated Test' and should be actioned by '' and mitigation resolution '' and have severity 1 and probability 2
    And confirms the creation of the radio
