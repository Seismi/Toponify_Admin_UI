...
Feature: Scopes and Layouts
  ...
  Scenario:  Delete a Layout from a scope and check it disappears from the table and topology dropdown
    ...
    Then the layouts table should not contain 'Automated Updated Regression Test Scope Layout' against the scope called 'Created Automated Regression Test Scope'
    And the user selects Topology menu item
  ...
  Scenario:  Delete a scope and check it disappears from the table and topology dropdown
    ...
    Then the scope called 'Created Automated Regression Test Scope' should not appear in the scopes table
    And the user selects Topology menu item
