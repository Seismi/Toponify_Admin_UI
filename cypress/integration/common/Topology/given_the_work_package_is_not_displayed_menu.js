...
Given('the work package {string} is not displayed on the {string} menu', function(work_package, work_package_menu) {
  let wait_for = [];
  ...
  cy.displayWorkPackage(work_package, work_package_menu, wait_for);
