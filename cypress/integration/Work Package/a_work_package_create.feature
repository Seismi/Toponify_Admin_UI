...
Feature: Work Package Create Feature
  ...
  Scenario: Create a work package in the work packages but cancel
    ...
    And the work package 'Created Automated Regression Test Work Package' should not be created
  ...
  Scenario: Create a work package in the details pane but cancel
    ...
    And the user creates a work package called 'Created Automated Regression Test Work Package', with a description 'Regression Test Work Package Description', baseline 'Current State' and owner 'Automated Regression Test Team (DO NOT DELETE)'
    And the user cancels the work package create
    Then the create package pop-up should close
    And the work package 'Created Automated Regression Test Work Package' should not be created
