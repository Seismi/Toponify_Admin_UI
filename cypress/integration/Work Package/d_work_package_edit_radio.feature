...
Feature: Work Package Edit Radio Feature
  ...
  Background:
    ...
    And the radio 'Automatic Regression Test Risk 1' does not exist against work package 'Automated Regression Test Work Package'
