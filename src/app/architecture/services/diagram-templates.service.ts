    ...
    return $(
      ...
      $(go.Panel,
        ...
        $(go.Panel,
          ...
          new go.Binding('visible', '', function (node) {
            return (node.data.relatedRadios.length > 0) && node.diagram.model.modelData.showRadioAlerts;
          }).ofObject(),
          $(go.Shape,
            'circle',
            {
          ...
          $(go.TextBlock,
           ...
           new go.Binding('text', 'relatedRadios', function (radios) {
             return radios.length.toString();
           })
          )
        )
      )
