...
import { DiagramService, Level, standardDisplayOptions } from '@app/version/services/diagram.service';
...
@Component({
  selector: 'app-version-diagram',
  templateUrl: './version-diagram.component.html',
  styleUrls: ['./version-diagram.component.scss']
})
export class VersionDiagramComponent implements OnInit, OnChanges, OnDestroy {
  ...
  ngOnChanges(changes: SimpleChanges) {
    ...
    if (changes.versionId) {this.diagramService.versionId = changes.versionId.currentValue; }
